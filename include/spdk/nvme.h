...
SPDK_STATIC_ASSERT(sizeof(struct spdk_nvme_ns_cmd_ext_io_opts) == 48 /* HACK */ + 24, "Incorrect size");
...
SPDK_STATIC_ASSERT(sizeof(struct spdk_nvme_io_qpair_opts) == 72 /* HACK */ + 16, "Incorrect size");
